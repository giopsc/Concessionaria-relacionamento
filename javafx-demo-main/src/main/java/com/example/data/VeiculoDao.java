...
public class VeiculoDao {
    ...
    public List<Veiculo> listarTodos() throws SQLException{
        var comando = conexao.prepareStatement("SELECT veiculos.*, clientes.nome, clientes.email FROM veiculos INNER JOIN clientes ON veiculos.cliente_id=clientes.id");
